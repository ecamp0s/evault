ITERACIÓN 1 — Historial y lecciones aprendidas

Archivo de la Iteración 1, cerrada el 30 de julio de 2026. Recoge la intención de
cada issue y lo que se aprendió al cerrarlo.

Está archivado, no muerto. Varias de estas lecciones han evitado horas de trabajo
y ninguna es obvia a posteriori: el guard que cachea el usuario y hace fallar los
tests de revocación, el CSS de plantilla que dejaba los encabezados negros sobre
fondo oscuro, el md5 con que el middleware de throttle construye su clave. Cuando
algo se comporte de forma rara en una zona que ya se tocó, merece la pena buscar
aquí antes de investigar desde cero.

El objetivo de la iteración era validar el stack completo (API, SPA, tokens,
