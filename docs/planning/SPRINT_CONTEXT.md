...
Y EL BLOQUE DE CADDY QUE HACE FALTA ESTÁ AHORA ESCRITO EN SETUP.md, que es lo que impide que esto vuelva a pasar: ese fichero vive en /etc/caddy, no está en el repositorio y necesita sudo, así que nadie podía reproducirlo leyendo el código y la única copia estaba en una máquina.
