...
El issue 161, los identificadores en español de los tests: 218 en web y 38 en api. Es lo único que queda del renombrado, y ahora es barato porque el comprobador ya distingue producción de tests y las siete capas de producción han dejado el rodaje hecho. Los textos de it y describe NO se tocan: van en español por convención.
