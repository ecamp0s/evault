...
El issue 183, la sexta capa: los 11 identificadores que quedan en api. Es la capa de menos riesgo porque no toca texto de interfaz, pero sí toca las claves de config/throttling.php, que NO se renombran: son configuración, no símbolos. El área web ya está a cero.
