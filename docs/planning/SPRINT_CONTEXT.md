...
El issue 180, la tercera capa del renombrado: components y la configuración de build. La capa se mide sola con ./scripts/check-identifiers.py --area web, sin inventariar nada a mano, y el texto visible se compara con node scripts/identifiers/dump-ui-text.mjs antes y después.
