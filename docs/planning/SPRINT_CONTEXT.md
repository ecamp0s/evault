...
LO QUE NO CUBRE es la pestaña realmente oculta, que sigue siendo manual con su guion en el 260. Y CONVIENE LEER BIEN EL PORQUÉ, porque la primera versión de esta nota lo decía mal y desanimaba más de la cuenta: lo medido es que /json/activate y Page.bringToFront NO ocultan la pestaña de la que salen. De ahí se concluyó que en headless no puede haber una pestaña oculta, y eso es falso — abrir una pestaña NUEVA sí oculta la anterior, y con cuatro abiertas tres reportan visibilityState hidden. Así se diagnosticó el 305. Lo que queda sin verificar es más pequeño: si quince minutos oculta producen estrangulamiento REAL, cosa que una sonda de doce segundos no podía ver porque Chromium lo aplica a los cinco minutos.
