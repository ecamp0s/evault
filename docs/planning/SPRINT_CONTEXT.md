...
La instancia personal está desplegada en kastor desde el 17 de agosto, en ~/apps/evault y por el puerto 443, sirviendo evault.local y evault-api.local con la CA interna de Caddy. Falta lo que solo puede hacer su dueño: instalar el certificado de la CA en los dispositivos, registrar el usuario real y verificarlo en un navegador. El certificado está en ~/evault-ca.crt de la propia máquina.
