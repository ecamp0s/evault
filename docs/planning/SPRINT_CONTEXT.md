...
Estado: Iteración 14 cerrada el 3 de septiembre de 2026. La 15 sin planificar; sus dos candidatos están al final, en SIGUIENTE PASO.
...
PLANIFICAR LA ITERACIÓN 15. El backlog está vacío salvo el 469, que es una medida en vuelo y no una tarea: no bloquea nada y su resultado llega el 9 de septiembre.

LOS DOS CANDIDATOS, y los dos los pidió quien tiene la vault el 3 de septiembre de 2026: la EXTENSIÓN de Firefox y Chrome, y OTROS TIPOS DE ENTRADA —tarjetas, notas, documentos—.

DE LOS DOS, EL SEGUNDO ES BARATO Y EL PRIMERO NO, y la diferencia está escrita para que no haya que redescubrirla. Añadir un campo al blob NO obliga a subir version —esa es la del esquema criptográfico y no la del contenido—, así que los tipos de entrada son trabajo de cliente sin decisiones nuevas. La extensión, en cambio, no puede empezar sin resolver DÓNDE VIVE LA CLAVE DESBLOQUEADA: Manifest V3 mata el service worker de fondo, y eso choca de frente con ADR-007, que dice que la clave vive solo en memoria. Eso es un ADR antes que un issue.

Y HAY UNA PIEZA DE INFORMACIÓN QUE LLEGA EL 9 Y QUE TOCA A LA EXTENSIÓN: el 469 mide si el navegador conserva lo que le dejas cuando nadie lo toca durante una semana. Es la misma pregunta que la extensión tiene que responder desde otro sitio — cuánto te puedes fiar de que el navegador conserve algo. No decide la iteración, pero conviene tenerlo antes de escribir ese ADR.

LO QUE QUEDA PENDIENTE Y TIENE DUEÑO CONOCIDO, y sigue igual al cerrar la 14: probar un código TOTP contra un servicio real, que es el criterio 2 de la 13 y necesita una cuenta de prueba y una persona; y bajar el recuento de la auditoría, que sigue en 246 de 369 con una contraseña compartida por 41 entradas. Las dos son trabajo de quien tiene la vault y no del repositorio, así que se anotan como medición y no como criterio.

LO QUE SIGUE SOBRE LA MESA Y NO ES CANDIDATO DE LA 15: una app nativa de iOS como proveedor de contraseñas, que NO se puede hacer con una PWA y es un cliente entero y no una funcionalidad; y leer una semilla desde un código QR, descartado en la 13.
