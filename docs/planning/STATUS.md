...
Issues: 131 en total, 122 cerrados, 9 abiertos
...
1. [#263](https://github.com/ecamp0s/evault/issues/263) fix(ops): el backup sube copias vacías sin protestar, porque descarta la cuenta de filas (High)
...
1. [#264](https://github.com/ecamp0s/evault/issues/264) fix(ops): el log del backup vive en /tmp y desaparece al apagar la máquina (Medium)
1. [#265](https://github.com/ecamp0s/evault/issues/265) chore(ops): que una noche sin copia se note (Medium)
...
1. ⬜ **La suite pasa 30 veces seguidas con la máquina cargada a propósito**, no en una máquina ociosa. El generador de carga vive en el repositorio: `./scripts/suite-under-load.sh`. Al planificar, 30 pasadas dieron **20 rojas y 10 verdes**, y la diferencia entre unas y otras fue únicamente la carga (#259).
