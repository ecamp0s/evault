...
Issues: 163 en total, 153 cerrados, 10 abiertos
...
1. [#320](https://github.com/ecamp0s/evault/issues/320) chore(web): convertir a inglés las pantallas, sin tocar el texto visible (Medium)
