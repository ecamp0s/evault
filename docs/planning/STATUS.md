...
8. ⬜ **`grep -rn "Filament" CLAUDE.md docs/` no devuelve ninguna promesa de futuro, y los dos READMEs hablan de eVault.** Lo que quede sobre Filament remite a `ADR-002` como decisión condicional o a `ADR-009` §4 como lo que la dejó sin sujeto (#324, #325).
