...
1. [#663](https://github.com/ecamp0s/evault/issues/663) docs: STATUS.md lleva solo la iteración en curso (High)
...
| [#663](https://github.com/ecamp0s/evault/issues/663) | docs: STATUS.md lleva solo la iteración en curso | `documentation` `s18` | Todo | High | #662 | #676 |
