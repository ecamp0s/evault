...
Issues: 46 en total, 34 cerrados, 12 abiertos
...
1. [#82](https://github.com/ecamp0s/evault-claude/issues/82) feat(api): almacenar la clave de vault envuelta (High) — **en curso**
...
| [#82](https://github.com/ecamp0s/evault-claude/issues/82) | feat(api): almacenar la clave de vault envuelta | `s3` `feat` `api` | In Progress | High | #80 | #83, #84 |
...
graph LR
  ...
  class I2,I3,I4,I5,I6,I17,I20,I35,I38,I43,I50,I51,I52,I53,I54,I55,I56,I57,I58,I79,I80,I81 hecho;
```
