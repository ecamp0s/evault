...
Issues: 259 en total, 254 cerrados, 5 abiertos
...
1. [#535](https://github.com/ecamp0s/evault/issues/535) feat(web): teclado numérico en los campos de la tarjeta, y la caducidad se escribe sin la barra (Medium)
...
| [#535](https://github.com/ecamp0s/evault/issues/535) | feat(web): teclado numérico en los campos de la tarjeta, y la caducidad se escribe sin la barra | `feat` `web` `s15` | Todo | Medium | — | #518 |
