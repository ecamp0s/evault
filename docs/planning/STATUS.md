...
Issues: 256 en total, 245 cerrados, 11 abiertos
...
1. [#509](https://github.com/ecamp0s/evault/issues/509) feat(web): la nota segura no enseña los campos que no tiene (Medium)
