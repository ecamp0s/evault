...
Issues: 235 en total, 225 cerrados, 10 abiertos
...
1. [#460](https://github.com/ecamp0s/evault/issues/460) feat(web): desbloquear la vault sin servidor cuando está cacheada (High)
