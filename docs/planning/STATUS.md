...
Issues: 256 en total, 244 cerrados, 12 abiertos
...
1. [#508](https://github.com/ecamp0s/evault/issues/508) feat(web): los cinco campos de la tarjeta en el editor, con sus tres secretos (High)
