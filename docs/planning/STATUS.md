...
Issues: 256 en total, 242 cerrados, 14 abiertos
...
1. [#506](https://github.com/ecamp0s/evault/issues/506) feat(web): guardar una entrada con tipo sin perder lo que el cliente no entiende (High)
