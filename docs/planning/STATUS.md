...
Issues: 319 en total, 317 cerrados, 2 abiertos
...
**Los ocho criterios cumplidos, el 1 con una salvedad.** El detalle y las lecciones están en [docs/planning/archive/ITERACION_17.md](archive/ITERACION_17.md).
...
| [#624](https://github.com/ecamp0s/evault/issues/624) | feat(web): reconciliar sin red | `feat` `web` `s18` | Todo | Low | #619 | — |
...
| [#628](https://github.com/ecamp0s/evault/issues/628) | chore: importar las cuatro fuentes reales sobre kastor | `chore` `s17` | Done | High | #626, #627 | #630 |
...
| [#630](https://github.com/ecamp0s/evault/issues/630) | docs: cerrar la Iteración 17 | `documentation` `s17` | Done | High | #628 | — |
| [#646](https://github.com/ecamp0s/evault/issues/646) | feat(web): olvidar el historial de contraseñas de toda la vault | `feat` `web` `s18` | Todo | Low | #621 | — |
