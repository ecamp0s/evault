...
Issues: 315 en total, 298 cerrados, 17 abiertos
...
1. [#616](https://github.com/ecamp0s/evault/issues/616) feat(web): agrupar los repetidos y proponer cuál sobrevive (High)
...
| [#616](https://github.com/ecamp0s/evault/issues/616) | feat(web): agrupar los repetidos y proponer cuál sobrevive | `feat` `web` `s17` | Todo | High | #615 | #617 |
