...
1. [#60](https://github.com/ecamp0s/evault-claude/issues/60) docs: planificar la Iteración 2 (sin prioridad)
...
| [#60](https://github.com/ecamp0s/evault-claude/issues/60) | docs: planificar la Iteración 2 | `s2` `chore` `documentation` | Todo | — | — | — |
