...
Issues: 256 en total, 249 cerrados, 7 abiertos
...
1. [#512](https://github.com/ecamp0s/evault/issues/512) feat(web): la búsqueda encuentra al titular y no al número de la tarjeta (Medium)
