...
Issues: 163 en total, 150 cerrados, 13 abiertos
...
1. [#317](https://github.com/ecamp0s/evault/issues/317) chore(web): convertir a inglés lib/vault, y fijar ahí el criterio (High)
