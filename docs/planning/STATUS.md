...
Issues: 256 en total, 243 cerrados, 13 abiertos
...
1. [#507](https://github.com/ecamp0s/evault/issues/507) feat(web): elegir el tipo al crear una entrada, y que elegir no cueste de más (Medium)
