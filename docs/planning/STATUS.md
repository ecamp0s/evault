...
1. ⬜ **`./scripts/check-comment-language.py --all` sale en verde, y es lo que el CI ejecuta en cada PR.** Las dos mitades: el árbol limpio y el comprobador en modo `--all` dentro del workflow `repositorio`, para que la regla siga teniendo red el día después de la iteración. La primera mitad la cierra #322; la segunda, #323, que es donde desaparecen las últimas 158 líneas junto con el andamiaje que las contiene (#322, #323).
