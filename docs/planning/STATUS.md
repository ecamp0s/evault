...
Issues: 256 en total, 248 cerrados, 8 abiertos
...
1. [#511](https://github.com/ecamp0s/evault/issues/511) feat(web): el botón de copiar de la fila copia lo que corresponde a cada tipo (Medium)
