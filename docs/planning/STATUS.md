...
Issues: 118 en total, 103 cerrados, 15 abiertos
...
1. [#223](https://github.com/ecamp0s/evault/issues/223) chore(ops): limpiar los restos del despliegue de prueba de kastor (Medium)
