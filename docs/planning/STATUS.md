...
Issues: 256 en total, 250 cerrados, 6 abiertos
...
1. [#513](https://github.com/ecamp0s/evault/issues/513) feat(web): el export se lleva los tipos, y el de texto plano también la tarjeta (Medium)
