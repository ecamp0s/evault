...
Issues: 235 en total, 227 cerrados, 8 abiertos
...
1. [#467](https://github.com/ecamp0s/evault/issues/467) feat(web): sin red no se escribe, y se dice por qué (Medium)
