...
Issues: 256 en total, 246 cerrados, 10 abiertos
...
1. [#510](https://github.com/ecamp0s/evault/issues/510) feat(web): el tipo de una entrada se ve de un vistazo en la lista (High)
...
1. [#515](https://github.com/ecamp0s/evault/issues/515) chore(web): comprobar por mutación que la auditoría no cuenta lo que no tiene contraseña (Medium)
