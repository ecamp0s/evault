...
Issues: 256 en total, 241 cerrados, 15 abiertos
...
1. [#505](https://github.com/ecamp0s/evault/issues/505) feat(web): la tarjeta se acota por tamaño y no se valida por forma (High)
