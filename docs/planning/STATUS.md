...
Issues: 235 en total, 231 cerrados, 4 abiertos
...
1. [#468](https://github.com/ecamp0s/evault/issues/468) chore(web): verificar el caché con kastor apagado de verdad (Medium)
...
| [#465](https://github.com/ecamp0s/evault/issues/465) | feat(web): service worker que cachea el shell y no las respuestas de la API | `feat` `web` `s14` | Done | High | #463 | #468 |
