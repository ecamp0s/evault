...
Issues: 218 en total, 214 cerrados, 4 abiertos
...
1. [#423](https://github.com/ecamp0s/evault/issues/423) test(web): el verificador de navegador cubre el segundo factor sobre la vault de 370 (High)
