...
it('crea el usuario y devuelve un token en claro', function (): void {
    $resultado = app(RegisterUser::class)->handle('Ada Lovelace', 'ada@evault.test', 'contraseña-larga');
...
it('hashea la contraseña', function (): void {
    $resultado = app(RegisterUser::class)->handle('Ada', 'ada@evault.test', 'contraseña-larga');
...
it('rechaza un email ya registrado aunque no pase por el Form Request', function (): void {
    ...
    expect(fn () => app(RegisterUser::class)->handle('Ada', 'ada@evault.test', 'contraseña-larga'))
...
it('no deja al usuario a medias si el alta falla', function (): void {
    ...
    try {
        app(RegisterUser::class)->handle('Ada', 'ada@evault.test', 'contraseña-larga');
